...
public class OrientedPieceTests
{
    ...
    {
        OrientedPiece sut = CreateOrientedPiece("Test", inputPositions.Select(Coord.Parse));
    ...
    {
        OrientedPiece a = CreateOrientedPiece("A", positions.Select(Coord.Parse));
        OrientedPiece b = CreateOrientedPiece("B", positions.Select(Coord.Parse));
    ...
    public void Distinct_WithEqualPositions_ReturnsSingle(params string[] positions)
    {
        ...
        {
            CreateOrientedPiece("A", positions.Select(Coord.Parse)),
            CreateOrientedPiece("B", positions.Select(Coord.Parse))
        };
    ...
    private static OrientedPiece CreateOrientedPiece(string name, params Coord[] positions) => new(_piece, name, positions);
